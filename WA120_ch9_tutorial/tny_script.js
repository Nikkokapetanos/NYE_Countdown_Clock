...
runClock();
// Use the setInterval method to keep the runClock()going
...
function runClock() {
   ...
   // Calculate the minutes and seconds in the current hours
   let minsLeft  = (hrsLeft - Math.floor(hrsLeft)) * 60;
   let secsLeft = (minsLeft - Math.floor(minsLeft)) * 60;

   // Display the time left until the New Year's Eve
